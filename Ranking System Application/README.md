We combined the Bubble Sort algorithm to sort small to medium sized unsorted arrays so we can sort them and then Binary search to find the element we are looking for within the arrays.
